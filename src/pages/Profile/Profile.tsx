  ...
  return (
    <>
      ...
      <section className=" bg-[#f0efef] ">
        <section
          className=" px-10 py-16 font-Nunito max-[650px]:px-
            ...
            <form>
              <section className=" border-b mt-4 pb-4">
                ...
                <p className=" text-[#484848] mt-2 tracking-wide">
                  ...
                  pet. By completing it now, you enable the pet's current owner
                  to understand the type of home you're offering. This assists
                  them in determining whether to consider your application
                  further or not.
                </p>
