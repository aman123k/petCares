  ...
  return (
    <>
      ...
      <section className=" bg-[#EEEEEE] ">
        <section className="font-Nunito py-8 text-[#595959] px-8 min-[2000px]:ml-[50%] min-[2000px]:translate-x-[-50%] ">
          <div className=" text-center">
            <h1 className=" font-bold text-3xl">Pet Welfare Guides</h1>
            <p className=" mt-2">
              What you need to know about providing the right basic care for
              your dog, cat, rabbit or parrot
            </p>
          </div>
          <section className=" grid grid-cols-2 gap-5 mt-16 max-[650px]:grid-cols-1">
            ...
            >
              ...
              <div className=" text-center">
                ...
                <p>
                  Here, you'll find out how to prepare for your new cat. Find
                  out how to provide the right diet, exercise, companionship and
