  ...
  return (
    <>
      ...
      <section className=" bg-adopterRegister max-[650px]:py-36 max-[650px]:px-8 py-56 object-cover text-white font-Nunito px-24">
        ...
        <h3 className=" font-bold text-4xl tracking-wide mt-4 max-[650px]:text-3xl min-[2000px]:ml-[28%]">
          Register For A PetCares Account
        </h3>
      </section>
      <section className="bg-[#F9F9F9]">
        <section
          className="flex gap-10 max-[650px]:gap-5  font-Nunito py-10 max-[850px]:flex-col-reverse 
        ...
        >
          ...
          <div className=" flex mt-4 w-[50%] flex-col gap-2 px-4 max-[650px]:px-6 max-[850px]:w-full max-[850px]:px-10">
            ...
            <p className=" mt-2 max-[650px]:mt-1">
              Creating a PetCares account is easy and free, it gives you access
              to features such as:
            </p>
            <ul
