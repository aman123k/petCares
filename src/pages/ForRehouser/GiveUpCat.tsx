        ...
        >
          ...
          <div className=" flex flex-col gap-3 max-[850px]:w-full w-[50%] text-[#595959]">
            ...
            <p className=" ">
              ...
              rehoming process with empathy and simplicity.
            </p>
            <ul className=" mt-4 flex flex-col  gap-4 ">
              ...
              <li className=" ">
                ...
                priority, and you retain control throughout the rehoming
                process.
              </li>
              <li className="  ">
                Choose PetCares for a direct rehoming service, avoiding rescue
